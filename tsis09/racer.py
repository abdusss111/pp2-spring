...
background = pygame.image.load('/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis9/mtrls/AnimatedStreet.png')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 10
        self.image = pygame.image.load('/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis9/mtrls/Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 5
        self.image = pygame.image.load('/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis9/mtrls/Player.png')
        self.rect = self.image.get_rect()
