...
pygame.mixer.init()
# load music files
music_dir = "/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis7/topl"
...
play_pause_images = [pygame.image.load("/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis7/animation/play-icon.png").convert_alpha(),
                     pygame.image.load("/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis7/animation/pause-icon.png").convert_alpha()]
play_pause_rect = play_pause_images[0].get_rect(center=(width//2, height-50))

# set up next/previous buttons
next_button_image = pygame.image.load("/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis7/animation/next-icon.png").convert_alpha()
next_button_rect = next_button_image.get_rect(center=(width-50, height-50))

prev_button_image = pygame.image.load("/Users/abdussalamabdurakhimov/Desktop/code/pp2/tsis7/animation/previous-icon.png").convert_alpha()
